    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_at', models.DateTimeField(auto_now_add=True)),
                ('asset_info', models.ForeignKey(to='web_models.Asset')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('asset', models.OneToOneField(to='web_models.Asset')),
            ],
        ),
        migrations.CreateModel(
            name='NIC',
        ...
        migrations.AddField(
            ...
            name='user_type',
            field=models.ForeignKey(to='web_models.UserType'),
        ),
        migrations.AddField(
            model_name='usergroup',
            name='users',
            field=models.ManyToManyField(to='web_models.UserProfile', null=True, blank=True),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='osinstall',
            name='server',
            field=models.ForeignKey(to='web_models.Server'),
        ),
        migrations.AddField(
            model_name='nic',
            name='server_info',
        ...
        migrations.AddField(
            model_name='businessunit',
            name='user_group',
            field=models.ForeignKey(blank=True, to='web_models.UserGroup', null=True),
        ),
        migrations.AddField(
            model_name='asset',
            name='business_unit',
            field=models.ForeignKey(verbose_name='\u5c5e\u4e8e\u7684\u4e1a\u52a1\u7ebf', blank=True, to='web_models.BusinessUnit', null=True),
        ),
        migrations.AddField(
            model_name='asset',
            name='contract',
            field=models.ForeignKey(verbose_name='\u5408\u540c', blank=True, to='web_models.Contract', null=True),
        ),
        migrations.AddField(
            model_name='asset',
            name='device_status',
            field=models.ForeignKey(to='web_models.Status'),
        ),
        migrations.AddField(
            model_name='asset',
            name='device_type',
            field=models.ForeignKey(to='web_models.DeviceType'),
        ),
        migrations.AddField(
            model_name='asset',
            name='idc',
            field=models.ForeignKey(verbose_name='IDC\u673a\u623f', blank=True, to='web_models.IDC', null=True),
        ),
        migrations.AddField(
            model_name='asset',
            name='tag',
            field=models.ManyToManyField(to='web_models.Tag', null=True, blank=True),
        ),
        migrations.AddField(
            model_name='admininfo',
            name='user_info',
            field=models.OneToOneField(to='web_models.UserProfile'),
        ),
